import { answer10 } from './answers10.js';
import Timer from './timer.js';

export default function Test10() {
    const buttonAnswer10 = document.querySelector('#answer10');
    ...
    buttonAnswer10.addEventListener('click', () => {
        Timer();
        counter.style.display = 'fixed';
        h1.remove();
        buttonAnswer10.remove();

        let score = 0;

        answer10.forEach((item) => {
