import { answer12 } from './answers12.js';
import Timer from './timer.js';

export default function Test12() {
    const buttonAnswer12 = document.querySelector('#answer12');
    ...
    buttonAnswer12.addEventListener('click', () => {
        Timer();
        counter.style.display = 'fixed';
        h1.remove();
        buttonAnswer12.remove();

        let score = 0;

        answer12.forEach((item) => {
